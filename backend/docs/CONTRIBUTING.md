...
详见 [docs/development/workflow.md](development/workflow.md)。这是本项目的**硬规则**，不是建议。
...
[看 Development Workflow](development/workflow.md)
...
详见 [testing.md](development/testing.md)
...
详见 [documentation-style.md](development/documentation-style.md)
